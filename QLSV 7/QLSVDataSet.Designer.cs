...
namespace QLSV_7 {
    ...
    public partial class QLSVDataSet : global::System.Data.DataSet {
        ...
        public partial class SinhVienDataTable : global::System.Data.TypedTableBase<SinhVienRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public SinhVienRow AddSinhVienRow(string MaSV, string MaTK, string Ho, string Ten, System.DateTime NgaySinh, bool GioiTinh, string Email, string SoDienThoai, string DiaChi, string GhiChu) {
...
namespace QLSV_7.QLSVDataSetTableAdapters {
    ...
    public partial class SinhVienTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[SinhVien] ([MaSV], [MaTK], [Ho], [Ten], [NgaySinh], [GioiTinh], [Email], [SoDienThoai], [DiaChi], [GhiChu]) VALUES (@MaSV, @MaTK, @Ho, @Ten, @NgaySinh, @GioiTinh, @Email, @SoDienThoai, @DiaChi, @GhiChu);
SELECT MaSV, MaTK, Ho, Ten, NgaySinh, GioiTinh, Email, SoDienThoai, DiaChi, GhiChu FROM SinhVien WHERE (MaSV = @MaSV)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[SinhVien] SET [MaSV] = @MaSV, [MaTK] = @MaTK, [Ho] = @Ho, [Ten] = @Ten, [NgaySinh] = @NgaySinh, [GioiTinh] = @GioiTinh, [Email] = @Email, [SoDienThoai] = @SoDienThoai, [DiaChi] = @DiaChi, [GhiChu] = @GhiChu WHERE (([MaSV] = @Original_MaSV) AND ([MaTK] = @Original_MaTK) AND ([Ho] = @Original_Ho) AND ([Ten] = @Original_Ten) AND ([NgaySinh] = @Original_NgaySinh) AND ([GioiTinh] = @Original_GioiTinh) AND ([Email] = @Original_Email) AND ([SoDienThoai] = @Original_SoDienThoai) AND ((@IsNull_DiaChi = 1 AND [DiaChi] IS NULL) OR ([DiaChi] = @Original_DiaChi)) AND ((@IsNull_GhiChu = 1 AND [GhiChu] IS NULL) OR ([GhiChu] = @Original_GhiChu)));
SELECT MaSV, MaTK, Ho, Ten, NgaySinh, GioiTinh, Email, SoDienThoai, DiaChi, GhiChu FROM SinhVien WHERE (MaSV = @MaSV)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::QLSV_7.Properties.Settings.Default.QLSVConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT MaSV, MaTK, Ho, Ten, NgaySinh, GioiTinh, Email, SoDienThoai, DiaChi, GhiCh" +
                "u FROM dbo.SinhVien";
        ...
        public virtual int Delete(string Original_MaSV, string Original_MaTK, string Original_Ho, string Original_Ten, System.DateTime Original_NgaySinh, bool Original_GioiTinh, string Original_Email, string Original_SoDienThoai, string Original_DiaChi, string Original_GhiChu) {
        ...
        public virtual int Insert(string MaSV, string MaTK, string Ho, string Ten, System.DateTime NgaySinh, bool GioiTinh, string Email, string SoDienThoai, string DiaChi, string GhiChu) {
            if ((MaSV == null)) {
        ...
        public virtual int Update(
                    ...
                    string Original_DiaChi, 
                    string Original_GhiChu) {
            return this.Update(Original_MaSV, MaTK, Ho, Ten, NgaySinh, GioiTinh, Email, SoDienThoai, DiaChi, GhiChu, Original_MaSV, Original_MaTK, Original_Ho, Original_Ten, Original_NgaySinh, Original_GioiTinh, Original_Email, Original_SoDienThoai, Original_DiaChi, Original_GhiChu);
        }
    }
